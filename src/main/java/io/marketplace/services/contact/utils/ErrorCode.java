...
public final class ErrorCode {
    ...
    public static final String USER_GET_VIA_MOBILE_ERROR_CODE = "092.01.500.02";
    ...
    public static final String WALLET_SEARCH_VIA_USER_ERROR_CODE = "092.01.500.03";
    ...
    public static final String WALLET_SEARCH_VIA_ACCOUNT_ERROR_CODE = "092.01.500.04";
